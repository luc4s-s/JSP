                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                ...
                                <c:if test="${imagemUser == '' || imagemUser == null}">
                                  <img class="img-80 img-radius" src="<%= request.getContextPath() %>/assets/images/Perfil.png" alt="User-Profile-Image">
                                </c:if>
                                
                                  <div class="user-details">
                                  								<!-- carregando o usuario logado --> <!-- ou session.getAttribute("usuario")   -->
                              ...
                              <div class="main-menu-content">
                                  <ul>
                                      <li class="more-details">
                                          ...
                                          <!-- chamando a servlet para fazer o logout -->
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                     ...
                                     <li class=" ">  
                                          <a href="<%=request.getContextPath() %>/principal/produto.jsp" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
